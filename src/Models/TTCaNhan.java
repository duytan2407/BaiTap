...
public class TTCaNhan {
    ...
    private  String MaNV,NoiSinh,NguyenQuan,DCThuongTru	,DCTamTru,SDT,CMTND,NgayCap,NoiCap,DanToc,TonGiao,QuocTich,TiengNN,TrinhDoNN,TDHocVan,GhiChu;	
    public TTCaNhan() {
    }    
    ...
    public TTCaNhan(String MaNV, String NoiSinh, String NguyenQuan, String DCThuongChu, String DCTamChu, String SDT, String CMTND, String NgayCap, String NoiCap, String DanToc, String TonGiao, String QuocTich, String TiengNN, String TrinhDoNN, String TDHocVan, String GhiChu) {
        ...
        this.DCThuongTru = DCThuongChu;
        this.DCTamTru = DCTamChu;
        this.SDT = SDT;
        this.CMTND = CMTND;
    ...
    public void setDCThuongTru(String DCThuongChu) {
        this.DCThuongTru = DCThuongChu;
    }
    ...
    public void setDCTamTru(String DCTamChu) {
        this.DCTamTru = DCTamChu;
    }
