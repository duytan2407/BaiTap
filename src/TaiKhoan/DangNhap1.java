...
public class DangNhap1 extends javax.swing.JDialog {
    ...
    private void btndangnhapKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btndangnhapKeyPressed
        ...
        try{
            ...
            if(nd == null)
            {
                MessageDialogHelper.Showmesserror(this,"Tên Đăng Nhập Hoặc Mật Khẩu Sai","Lỗi!");
    ...
    private void txtpassKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtpassKeyPressed
        ...
        try{
            ...
            if(nd == null)
            {
                MessageDialogHelper.Showmesserror(this,"Tên Đăng Nhập Hoặc Mật Khẩu Sai","!");

            }
            else{
                Share.nguoidangnhap = nd ;
                MessageDialogHelper.Showmess(this, "Đăng Nhập Thành Công", "Chào Mừng Bạn Đã Quay Trở Lại");
                this.dispose();
            }
